      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-700">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
            <Send className="h-5 w-5 mr-2 text-blue-600 dark:text-blue-400" />
            Send Notification
          </h2>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 resize-none"
              />
            </div>
        ...
        {/* Quick Templates */}
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-700">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Quick Templates</h2>
          <div className="space-y-3">
            {notificationTemplates.map((template) => {
              const Icon = template.icon;
              return (
                <div key={template.id} className="flex items-center p-3 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-colors">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">{template.body}</p>
                  </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-700">
        <div className="flex items-center justify-between mb-4">
          ...
          {notifications.length > 0 && (
            <button
              ...
              className="text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 text-sm font-medium flex items-center space-x-1"
            >
        ...
        {notifications.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-400 dark:text-gray-500">Use the "Send Demo Notification" button to test the system</p>
          </div>
        ) : (
          <div className="space-y-3">
            {notifications.map((notification) => (
              ...
              >
                <div className={`p-2 rounded-full mr-3 ${notification.read ? 'bg-gray-300 dark:bg-gray-600' : 'bg-blue-500'}`}>
                  <Bell className={`h-4 w-4 ${notification.read ? 'text-gray-600 dark:text-gray-300' : 'text-white'}`} />
                </div>
                <div className="flex-1">
