...
const HolidayCalendar = () => {
  ...
  const getTypeColor = (type) => {
    switch (type) {
      ...
      case 'Religious Holiday': return 'bg-purple-100 text-purple-800';
      case 'School Event': return 'bg-blue-100 text-blue-800';
      case 'Academic Break': return 'bg-green-100 text-green-800';
      case 'Professional Development': return 'bg-amber-100 text-amber-800';
      default: return 'bg-gray-100 text-gray-800';
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-green-600">{confirmedHolidays}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-yellow-600">{pendingHolidays}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 mb-1">Recurring</p>
              <p className="text-2xl font-bold text-purple-600">{recurringHolidays}</p>
            </div>
            ...
            <tbody className="divide-y divide-gray-200">
              {filteredHolidays.map((holiday) => (
                <tr key={holiday.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <div>
                      ...
                      {holiday.isRecurring && (
                        <div className="flex items-center mt-1">
                          ...
                          <span className="text-xs text-yellow-600">Recurring</span>
                        </div>
                      )}
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">{holiday.duration}</div>
                  </td>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          ...
          <div className="space-y-3">
            {getUpcomingHolidays().map(holiday => (
              <div key={holiday.id} className="flex justify-between items-center p-2 bg-blue-50 rounded">
                <div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-600">Religious Holidays</span>
              <span className="text-sm font-medium text-gray-900">
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-600">Academic Breaks</span>
              <span className="text-sm font-medium text-gray-900">
